...
import sys
import threading
from rs4.protocols.http2.hyper.common.exceptions import ConnectionResetError
import platform
IS_PYPY = platform.python_implementation() == 'PyPy'

def test_http2 (launch):
    if IS_PYPY:
        # rs4.protocols.http2.hyper has secure connection problem
        return
...
def test_http3 (launch):
    ...
    from rs4.protocols.http3.events import ConnectionShutdownInitiated

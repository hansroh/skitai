import pytest, os
from skitai.http_server import http_server, http_channel
from skitai.https_server import https_server, init_context
...
def test_https_server (log):
	...
	s = https_server ('0.0.0.0', 3000, ctx, log.get ("server"), log.get ("request"))	
	s.close ()

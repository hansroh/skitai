...
def handle_page (rc):		
	...
	rc.logger ("[info] response code: %d, %s %s" % (rc.response.code, rc.uinfo.rfc, rc.response.text ()))
...
if __name__ == "__main__":				
	...
	requests.add ("ws://app:1111@hq.lufex.com:5000/websocket/echo --wsoc-message hello 3, hans", handle_page)

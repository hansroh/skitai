...
def use_tsocket ():
	import socket
	if hasattr(socket, "_timeoutsocket"):
		socket._no_timeoutsocket = socket.socket
		socket.socket = socket._timeoutsocket
		del socket._timeoutsocket
	
def use_socket ():	
	import socket
	if hasattr(socket, "_no_timeoutsocket"):
		socket._timeoutsocket = socket.socket
